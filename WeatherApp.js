...
// import rain_ani from "./Assets/rain_ani.gif";
// import sum_ani from "./Assets/sum_ani.gif";

const WeatherApp = () => {

    let api_key = "1f53c7e1034b388ab1d4d64d544ee60f";
    ...
    return(
        <div className="container">
            <div className="box">
                ...
                <img src={humidity_icon} alt="Error" className="icon"/>
                <div className="data">
